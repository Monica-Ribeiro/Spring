...
public class TestesJPa {
	...
	buscaTodosContatosComOrdenacaoRetornaListaOrdenadaDeFormaDescendente() {
		List<Contato> contatos = 
		contatoRepository.buscaTodosContatosComOrdenacao2(Sort.by(Direction.DESC, "nome"));
		Assert.assertTrue(contatos.get(0).getNome().equals("Novo Chefe"));
	}
	
	@Test
	public void
	buscaTodosContatosComOrdenacaoRetornaListaOrdenadaDeFormaAscendente() {
		List<Contato> contatos = 
		contatoRepository.buscaTodosContatosComOrdenacao2(Sort.by(Direction.ASC, "nome"));
